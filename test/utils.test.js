import { countCharOccurrences, floorTo2DP, roundTo2DP } from "../lib/utils.js";
...
describe("floorTo2DP", () => {
  ...
  test("throws an error if value is not a number", () => {
    expect(() => roundTo2DP("123")).toThrowError(
      `argument 'value' must be a number`
    );
    expect(() => roundTo2DP({ 1: "23" })).toThrowError(
      `argument 'value' must be a number`
    );
    expect(() => roundTo2DP(["123"])).toThrowError(
      `argument 'value' must be a number`
    ...
    expect(() => roundTo2DP(true)).toThrowError(
      `argument 'value' must be a number`
    );
  });
});
describe("roundTo2DP", () => {
  test("returns value floored to 2dp", () => {
    ...
    expect(roundTo2DP(-10.001)).toBe(-10.0);
    expect(roundTo2DP(-10.004)).toBe(-10.0);
    expect(roundTo2DP(-10.005)).toBe(-10.01);
    expect(roundTo2DP(-10.009)).toBe(-10.01);
  ...
  test("throws an error if value is not a number", () => {
    expect(() => floorTo2DP("123")).toThrowError(
      `argument 'value' must be a number`
    );
    expect(() => floorTo2DP({ 1: "23" })).toThrowError(
      `argument 'value' must be a number`
    );
    expect(() => floorTo2DP(["123"])).toThrowError(
      `argument 'value' must be a number`
    ...
    expect(() => floorTo2DP(true)).toThrowError(
      `argument 'value' must be a number`
    );
  });

  test("throws an error if value is not defined", () => {
    expect(() => floorTo2DP(undefined)).toThrowError(
...
describe("countCharOccurrences", () => {
  test("returns the number of times the character appears in the string, case sensitive", () => {
    ...
    expect(
      countCharOccurrences(
        "11111110000001111111sadfhkjshdfkjshdfkjshdfh111111",
        "1"
      )
    ).toBe(20);
  });
  ...
  test("throws an error if str is not a string", () => {
    expect(() => countCharOccurrences(123, "c")).toThrowError(
      `argument 'str' must be a string`
    );
    expect(() => countCharOccurrences({ 1: "23" }, "c")).toThrowError(
      `argument 'str' must be a string`
    );
    expect(() => countCharOccurrences(["123"], "c")).toThrowError(
      `argument 'str' must be a string`
    ...
    expect(() => countCharOccurrences(true, "c")).toThrowError(
      `argument 'str' must be a string`
    );
  });
  test("throws an error if char is not a string", () => {
    expect(() => countCharOccurrences("test", 123)).toThrowError(
      `argument 'char' must be a string`
    );
    expect(() => countCharOccurrences("test", { 1: "23" })).toThrowError(
      `argument 'char' must be a string`
    );
    expect(() => countCharOccurrences("test", ["123"])).toThrowError(
      `argument 'char' must be a string`
    ...
    expect(() => countCharOccurrences("test", true)).toThrowError(
      `argument 'char' must be a string`
    );
  });
});
