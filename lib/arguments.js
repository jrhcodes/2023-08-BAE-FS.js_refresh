...
export const requiredArgument = (variableInfo) => {
...
export const requiredStringArrayArgument = (variableInfo) => {
    ...
    if (!Array.isArray(array) || array.length == 0 || !array.every(element => typeof element === 'string')) {
        throw new Error(_errorMessageStringArrayRequired(variableName));
    }
};
...
export const requiredNumberArrayArgument = (variableInfo) => {
    const [variableName, array] = Object.entries(variableInfo)[0];
    baseArgumentRequired(array, variableName);
    if (!Array.isArray(array) || array.length == 0 ||!array.every(element => typeof element === 'number')) {
        throw new Error(_errorMessageNumberArrayRequired(variableName));
    }
};
...
export const requiredIntegerArrayArgument = (variableInfo) => {
    ...
    if (!Array.isArray(array) || array.length == 0 
        || array.some(element => typeof element !== 'number' || element % 1 !== 0)) {
        throw new Error(_errorMessageIntegerArrayRequired(variableName));
    }
};
...
export const requiredPositiveIntegerArrayArgument = (variableInfo) => {
    ...
    if (!Array.isArray(array) || array.length == 0 
        || !array.every(element => typeof element === 'number' && element > 0 && element % 1 === 0)) {
        throw new Error(_errorMessagePositiveIntegerArrayRequired(variableName));
    }
};
